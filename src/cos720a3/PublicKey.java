 ...
 * 1) PublicKey() - construct a new key
 ...
 * 5) getFromKnapsack(int index), getQ(), getR, derivePrivateKey() - after 1-4 are done, these methods may be called repeatedly and in any order.
...
public class PublicKey {
     ...
     * @return A PrivateKey object that is the derivative of this key.
     ...
     */
    public PrivateKey derivePrivateKey () throws RuntimeException {
        if (this.knapsack == null || this.knapsack.isEmpty() || this.q == null || this.r == null || !this.isValid()) {
            this.clearKey();
            throw new RuntimeException ("Key is invalid");
        }
